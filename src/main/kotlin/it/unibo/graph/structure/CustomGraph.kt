...
class CustomGraph(g: it.unibo.graph.Graph) : Graph, it.unibo.graph.Graph by g {
    ...
    override fun addProperty(nodeId: Long, key: String, value: Any, type: PropType, from: Long, to: Long): P {
        return addProperty(CustomProperty<String>(nextPropertyId(), nodeId, key, value, type, from, to))
    }
